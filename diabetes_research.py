...
def correlation_matrix(df, cols):
    ...
    fig = sns.heatmap(df[cols].corr(), annot=True, linewidth=0.5, annot_kws={'size':12}, linecolor='w', cmap='RdBu')
    plt.show(block=True)
...
# Son güncel degisken türlerimi tutuyorum.
cat_cols, num_cols, cat_but_car = grab_col_names(df, cat_th=5, car_th=20)
